...
│   ├── Phase8缺陷修复计划-2026-09-18.md      # M1-M5 整改（已实施，原 .qoder 过程稿）
│   ├── Phase8补全实现方案-2026-09.md          # Phase 8 骨架补全盘点（已实施，原 .qoder）
│   ├── 媒体加载性能提升方案-2026-09-原稿.md   # IDE 原稿（权威版见 archive/同名文件）
│   └── 项目状态分析与规划-2026-09-18.md      # 快照与规划（未执行项已入 roadmap，原 .qoder）
